...
class CorobotManager():
    ...
    def scan_callback(self,scan):
        msg = "SCAN"
        for p in len(scan.ranges):
            msg += " " + str(scan.ranges[p]) + " " + str(scan.angle_min+p*scan.angle_increment)
        self.scansub.unregister()
        self.client_write(self.scanmsgid,msg)
    ...
    def handle_command(self, command):
        ...
        elif msg_type == "GETSCAN":
            self.scanmsgid = msg_id
