...
#include "corobot_common/Landmark.h"

#include "obstacle_avoidance.h"
#include "wall_detection.h"
#include "ros/ros.h"
#include "corobot_common/Wall.h"
#include "corobot_common/Goal.h"
#include <sstream>

using geometry_msgs::Point;
using namespace std;
using corobot_common::Landmark;
...
#define MIN_OMEGA 0.2

/** Maximum rotational velocity. */
#define MAX_OMEGA 0.5
 ...
 public:
    ...
    APF()
        {       
            ...
            perpForcePublisher = n.advertise<corobot_common::Goal>("ch_perpforce", 1);
            repForcePublisher = n.advertise<corobot_common::Goal>("ch_repforce", 1);
            ...
            // /ruchin
            wd = new WallDetector();
            wallPublisher = n.advertise<corobot_common::Wall>("wall",1);
            goal.x = 0;
            goal.y = 0; 
            cmdPrev.a = 0;
            cmdPrev.d = 0;
...
protected:
    ...
    ros::Publisher rawnavPublisher, obsPublisher, absGoalPublisher, netForcePublisher,
      ...
      // tony
      perpForcePublisher, repForcePublisher, 
      // /tony
      // ruchin
      wallfPublisher,
      // /ruchin
    ...
    Point calcGoalForce(Point &goalWrtRobot, double now);
    void updateNetForce(Point &netForce, double now);
    void updateObstacleList(list<Polar>& objects);
    // binit FMD
    Polar getFeasibleMotionDirection(Point &goalWrtRobot);
    // /binit FMD
