...
def wall_callback(wall):
    rospy.loginfo('Wall incoming, left: %s at %5.3f, right: %s at %5.3f',str(wall.is_wall_left),wall.thetaleft,str(wall.is_wall_right),wall.thetaright)
    if wall.is_wall_left:
        ekf.use_wall_angle(wall.thetaleft*pi/180.0)
